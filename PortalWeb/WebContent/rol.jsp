...
<c:if test="${requestScope.MENSAJE!=null}">
	...
	<div class="container">
		<h2 class="text-center mt-5 mb-5">Nuevo Rol</h2>
		<form method="post" action="ServletRol?operacion=REGISTRAR" id="solicitud-form">
	...
	<script>
		...
		$(".btn-secondary").click(function () {
			window.location.href='ServletRol?operacion=LISTAR';
		})
	</script>
