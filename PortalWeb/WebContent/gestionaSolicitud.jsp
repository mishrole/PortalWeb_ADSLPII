...
<form method="post" action="ServletPendientes?accion=GESTIONAR" id="gestionar-form">
  ...
  <div class="form-group row">
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-8 validarGestion">
      ...
      <input type="text" class="d-none form-control" id="codTecnicoSeleccionado" name="tecnicoselec">
    </div>
    <div class="col-sm-2">
